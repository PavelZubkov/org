...
var $;
(function ($) {
    class $org_gate_domain extends $mol_object2 {
        static state() {
    ...
    __decorate([
        $mol_mem
    ], $org_gate_domain.prototype, "user", null);
    __decorate([
        $mol_mem
    ], $org_gate_domain, "state", null);
    $.$org_gate_domain = $org_gate_domain;
})($ || ($ = {}));
//org/gate/domain/domain.ts
;
"use strict";
var $;
(function ($) {
...
var $;
(function ($) {
    class $org_gate_sign_up extends $mol_page {
        domain() {
        ...
        Submit() {
            ...
            obj.click = (val) => this.submit_event(val);
            return obj;
        }
        Form() {
    ...
    __decorate([
        $mol_mem
    ], $org_gate_sign_up.prototype, "domain", null);
    __decorate([
        $mol_mem
    ], $org_gate_sign_up.prototype, "name", null);
    __decorate([
        $mol_mem
    ], $org_gate_sign_up.prototype, "Name_control", null);
    __decorate([
        $mol_mem
    ], $org_gate_sign_up.prototype, "Name", null);
    __decorate([
        $mol_mem
    ], $org_gate_sign_up.prototype, "pass", null);
    __decorate([
        $mol_mem
    ], $org_gate_sign_up.prototype, "Pass_control", null);
    __decorate([
        $mol_mem
    ], $org_gate_sign_up.prototype, "Pass", null);
    __decorate([
        $mol_mem
    ], $org_gate_sign_up.prototype, "submit_event", null);
    __decorate([
        $mol_mem
    ], $org_gate_sign_up.prototype, "Submit", null);
    __decorate([
        $mol_mem
    ], $org_gate_sign_up.prototype, "Form", null);
    $.$org_gate_sign_up = $org_gate_sign_up;
})($ || ($ = {}));
//org/gate/sign/up/-view.tree/up.view.tree.ts
;
"use strict";
var $;
(function ($) {
    var $$;
    (function ($$) {
        class $org_gate_sign_up extends $.$org_gate_sign_up {
            submit_event() {
...
//org/gate/sign/up/up.view.ts
;
"use strict";
var $;
(function ($) {
    class $org_gate_sign_in extends $org_gate_sign_up {
        title() {
            return this.$.$mol_locale.text('$org_gate_sign_in_title');
        }
    }
    $.$org_gate_sign_in = $org_gate_sign_in;
})($ || ($ = {}));
//org/gate/sign/in/-view.tree/in.view.tree.ts
;
"use strict";
var $;
(function ($) {
    class $org_gate extends $mol_book2_catalog {
        domain() {
            const obj = new this.$.$org_gate_domain();
            return obj;
        }
    ...
    __decorate([
        $mol_mem
    ], $org_gate.prototype, "domain", null);
    __decorate([
        $mol_mem
    ], $org_gate.prototype, "Sign_in", null);
    __decorate([
        $mol_mem
    ], $org_gate.prototype, "Sign_up", null);
    $.$org_gate = $org_gate;
})($ || ($ = {}));
//org/gate/-view.tree/gate.view.tree.ts
;
"use strict";
var $;
(function ($) {
    var $$;
    (function ($$) {
        class $org_gate extends $.$org_gate {
            auto() {
                debugger;
                this.domain().user().list();
            }
        }
        $$.$org_gate = $org_gate;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//org/gate/gate.view.ts
;
"use strict";
var $;
(function ($) {
...
var $;
(function ($) {
    class $org_gate_user_service extends $mol_object2 {
        domain() {
    ...
    __decorate([
        $mol_mem
    ], $org_gate_user_service.prototype, "state", null);
    __decorate([
        $mol_mem
    ], $org_gate_user_service.prototype, "list", null);
    __decorate([
        $mol_mem_key
    ], $org_gate_user_service.prototype, "check_exists", null);
    __decorate([
        $mol_mem_key
    ], $org_gate_user_service.prototype, "get", null);
    __decorate([
        $mol_action
    ], $org_gate_user_service.prototype, "create", null);
    $.$org_gate_user_service = $org_gate_user_service;
    class $org_gate_user extends $mol_object2 {
        id() {
            return this.$.$mol_fail('Not defined');
        }
        domain() {
    ...
    __decorate([
        $mol_mem
    ], $org_gate_user.prototype, "state", null);
    $.$org_gate_user = $org_gate_user;
})($ || ($ = {}));
//org/gate/user/user.ts
;
export default $
